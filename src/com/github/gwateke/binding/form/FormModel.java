 ...
 * the License.
 */
package com.github.gwateke.binding.form;
 ...
 */
public interface FormModel<B> extends PropertyChangePublisher {
     ...
     */
    void setFormObject(B formObject);
     ...
     * form.
     */
    ValueModel<B> getFormObjectHolder();
...
//    public void registerPropertyConverter( String propertyName, Converter toConverter, Converter fromConverter );
     ...
     * happens.
     */
    void addCommitListener(CommitListener<B> listener);

    /**
     * Removes the specified listener to the list if listeners notified when a commit 
     * happens.
     */
    void removeCommitListener(CommitListener<B> listener);
